...
INSERT INTO songs 
	 ...
	 VALUES
			...
			('Overworld Theme',				1, 1, '300',	'zelda/03_overworld_theme.mp3',			2),
			('Dungeon Theme',				1, 1, '300',	'zelda/04_dungeon_theme.mp3',			3),
			...
			('Ganon Dungeon',				1, 1, '300',	'zelda/10_ganon_dungeon.mp3',			9),
			('Ganon Defeated',				1, 1, '4',		'zelda/11_ganon_defeated.mp3',			10),
			('Ending Theme',				1, 1, '300',	'zelda/12_ending_theme.mp3',			11),
			...
			('Ryu',							6, 8, '147',	'sf2/04_ryu.mp3',						4),
			('E. Honda',					6, 8, '205',	'sf2/05_e_honda.mp3',					5),
			('Blanka',						6, 8, '200',	'sf2/06_blanka.mp3',					6),
			('Guile',						6, 8, '222',	'sf2/07_guile.mp3',						7),
			('Ken',							6, 8, '213',	'sf2/08_ken.mp3',						8),
			('Chun li',						6, 8, '153',	'sf2/09_chun_li.mp3',					9),
			('Zangief',						6, 8, '147',	'sf2/10_zangief.mp3',					10),
			('Dhalsim',						6, 8, '130',	'sf2/11_dhalsim.mp3',					11),
			...
			('Balrog',						6, 8, '150',	'sf2/18_balrog.mp3',					18),
			('Vega',						6, 8, '204',	'sf2/19_vega.mp3',						19),
			('Sagat',						7, 8, '255',	'sf2/20_sagat.mp3',						20),
			('M. Bison',					6, 8, '217',	'sf2/21_bison.mp3',						21),
			('Ryu\'s Ending',				6, 8, '100',	'sf2/22_ryu_ending.mp3',				22),
			('E. Honda\'s Ending',			6, 8, '56',		'sf2/23_honda_ending.mp3',				23),
			('Blanka\'s Ending',			6, 8, '107',	'sf2/24_blanka_ending.mp3',				24),
			('Guile\'s Ending',				6, 8, '55',		'sf2/25_guile_ending.mp3',				25),
			('Ken\'s Ending 1',				6, 8, '101',	'sf2/26_ken_ending1.mp3',				26),
			('Ken\'s Ending 2',				6, 8, '45',		'sf2/27_ken_ending2.mp3',				27),
			('Chun Li\'s Ending 1',			6, 8, '132',	'sf2/28_chun_li_ending1.mp3',			28),
			...
			('Who... Are You',				5, 9, '130',	'ff7/17_who_are_you.mp3',				17),
			('Don of the Slums',			5, 9, '210',	'ff7/18_don_slums.mp3',					18),
			('Infiltrating Shinra',			5, 9, '347',	'ff7/19_infiltrating_shinra.mp3',		19),
			('Those Who Fight Further',		5, 9, '331',	'ff7/20_fight_further.mp3',				20),
			('Red XIII\'s Theme',			5, 9, '127',	'ff7/21_red_13_theme.mp3',				21),
			('Crazy Motorcycle',			5, 9, '335',	'ff7/22_crazy_motorcycle.mp3',			22),
			('Dear to the Heart',			5, 9, '213',	'ff7/23_dear_heart.mp3',	 			23),
			('Main Theme Final Fantasy VII',5, 9, '628',	'ff7/24_main_theme.mp3',				24),
			('On Our Way',					5, 9, '343',	'ff7/25_on_our_way.mp3',				25),
			('Good Night, Until Tomorrow',	5, 9, '10',		'ff7/26_good_night.mp3',				26),
			('On that day, five years ago',	5, 9, '313',	'ff7/27_that_day.mp3',					27),
			('Farm Boy',					5, 9, '251',	'ff7/28_farm_boy.mp3',					28),
